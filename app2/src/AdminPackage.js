...
export default function AdminPackage()
{
  ...
  <div className="card shadow">
    <div className="card-header text-bg-primary d-flex justify-content-between">
      ...
      <a href="doctor-add-package.html" className="btn btn-light">Add Package <i className="fa fa-save" /></a>
    </div>
      ...
      <table className="table table-bordered table-striped">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <a title="edit package" href="doctor-edit-package.html"><i className="fa fa-pencil fa-2x m-1" /></a>
              <a title="remove package" href="#"><i className="fa fa-trash fa-2x m-1" /></a>
            </td>
          </tr>
        </tbody>
      </table>
